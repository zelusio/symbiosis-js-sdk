...
export interface AaveInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'authorizeLendingPool', values: [string]): string
    encodeFunctionData(
    ...
    encodeFunctionData(functionFragment: 'repayETH', values: [string, BigNumberish, BigNumberish, string]): string
...
export interface Aave extends BaseContract {
    ...
    callStatic: {
        authorizeLendingPool(lendingPool: string, overrides?: CallOverrides): Promise<void>
        ...
        withdrawETH(lendingPool: string, amount: BigNumberish, to: string, overrides?: CallOverrides): Promise<void>
    }
